<?php
/**
 * Mandrill SMTP Mailer Configuration
 */
...
// Prevent re-initialization if already loaded via mu-plugins
...
if (!defined('MANDRILL_API_KEY')) {
    define('MANDRILL_API_KEY', getenv('MANDRILL_API_KEY') ?: 'md-zfK92yc0RIz7lQUB9m377Q');
}
